...
int mdss_dsi_panel_eye_mode(struct mdss_panel_data *pdata, int eye_mode)
{
	struct mdss_dsi_ctrl_pdata *ctrl = NULL;
	struct mdss_panel_info *pinfo;
	struct dsi_panel_cmds *eye_cmds;
	int ret = 0, i = 0;
	...
	if ((i < 0) || (i > 7)){
		...
		pr_err("%s: Invalid input eye_mode\n", __func__);
		return -EINVAL;
	}

	pr_err("%s[Display]: panel eye mode code +. \n", __func__);
	...
	eye_cmds = &ctrl->eye_cmds[i];
		if (eye_cmds->cmd_cnt){
			pr_err("%s[Display]: eye_cmd[%d].\n", __func__, i);
			mdss_dsi_panel_cmds_send(ctrl, eye_cmds, CMD_REQ_COMMIT);
		}
			...
			struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[7],
		"qcom,mdss-dsi-panel-eye-command08", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[6],
		"qcom,mdss-dsi-panel-eye-command07", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[5],
		"qcom,mdss-dsi-panel-eye-command06", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[4],
		"qcom,mdss-dsi-panel-eye-command05", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[3],
		"qcom,mdss-dsi-panel-eye-command04", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[2],
		"qcom,mdss-dsi-panel-eye-command03", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[1],
		"qcom,mdss-dsi-panel-eye-command02", "qcom,mdss-dsi-panel-gamma-command-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->eye_cmds[0],
		"qcom,mdss-dsi-panel-eye-command01", "qcom,mdss-dsi-panel-gamma-command-state");
	...
	int ndx)
{
	...
	ctrl_pdata->panel_data.mdss_dsi_panel_eye_mode =
									mdss_dsi_panel_eye_mode;
